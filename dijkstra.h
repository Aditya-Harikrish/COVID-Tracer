...
// has a worst case time complexity of O(n) as the max edge in a path can be n-1
int comp(vector* P1, vector* P3);

// to get the path from a src to dest in a vector
// has a worst case time complexity of O(n) as the max edges in a path can be n-1
...
// has worst case time complexity of O(n) as the max edges in a path is n-1
...
// has worst case time complexity of O(n^3)
