...
void init_station(station* station_object, int id, int K)
{
    ...
    if(((*station_object).array_people==NULL)||((*station_object).array_time_personLeft==NULL)||((*station_object).array_time_personVisit==NULL)||((*station_object).Arraytotal==NULL))
    {
